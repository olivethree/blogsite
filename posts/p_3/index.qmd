...
![](logo.svg){fig-align="center" width="220"}
...
`rcisignal` ships a coordinated `rel_*` family for these:
...
## Worked example using real data: Oliveira et al. (2019)
...
### Per-region informational value
...
Looking at these results was quite a thrill. This was my first published paper of my PhD project. It was published a long time ago, in a world where the infoVal metric was not yet established, there was no clear understanding of the limitations of Phase 2 trait ratings using group CIs, and I was but a young apprentice learning the new ways of doing research post-reproducibility crisis. *What if the results do not replicate with a more scrutinized data pipeline? What if the infoVals suggest none of my CIs in that paper had any signal? What if the reliability analyses show no agreement?* Lucky me...the results were not only replicated, BUT extended to a new level of insights about the data. What a ride! Anyway...this could be useful for any meta-analysis enthusiasts out there ;)
...
-   **Zenodo record**: <https://doi.org/10.5281/zenodo.19961180>
